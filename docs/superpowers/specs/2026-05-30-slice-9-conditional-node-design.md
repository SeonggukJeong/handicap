...
- proto `MetricBatch.branch_stats`(새 field 번호, prost exhaustive literal 전 사이트), controller `run_if_metrics`(migration 0005, branch는 TEXT 키 — SF-4), `ReportStep.branch_breakdown`.
