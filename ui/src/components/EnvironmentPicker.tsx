...
type Props = {
  ...
  /** When false (simple mode), only the env selector and an applied-count hint are
   *  rendered — the base-var list, override editor, and add-row are hidden.
   *  Defaults to true (full editor). All existing callers omit this prop → byte-identical. */
