...
<!-- TODO: 스크린샷 추가 — 아래 주석을 해제하고 docs/images/에 이미지를 넣어주세요.
     추천 구성: ① 시나리오 에디터(아웃라인+YAML 나란히) ② Run 다이얼로그 ③ 리포트(SLO 판정 배지 포함)
![시나리오 에디터](docs/images/editor.png)
![리포트](docs/images/report.png)
-->
